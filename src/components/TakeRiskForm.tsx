...
export function TakeRiskForm({ risk, onSubmit, onCancel, showActions = true }: TakeRiskFormProps) {
  ...
  const handleSubmit = () => {
    if (onSubmit && premium && selectedCoverages.length > 0) {
      onSubmit(parseFloat(premium), selectedCoverages);
      // Reset form
      setPremium("");
