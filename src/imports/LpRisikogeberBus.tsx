import svgPaths from "./svg-7xxkn5qq5o";
...
import imgImage from "figma:asset/74503bfc0cde48656b8667a50fffd00beea668cd.png";
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-[#e6e5e5] w-full">
      <p className="[text-shadow:#000000_10px_5px_40px] font-['Inter:Black',sans-serif] font-black leading-[1.3] relative shrink-0 text-[52px] w-full">{`Mit dem T3 über die Alpen. Aber was, wenn er's nicht schafft?`}</p>
      <p className="[text-shadow:#000000_10px_5px_40px] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.5] relative shrink-0 text-[18px] w-full">Du liebst deinen Bus. Aber er ist alt. Und die Berge sind hoch. Absichern gegen Pannen – damit aus dem Traum kein Albtraum wird.</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[1.3] relative shrink-0 w-full">
      ...
      <p className="font-['Inter:Black',sans-serif] font-black not-italic relative shrink-0 text-[#e6e5e5] text-[18px] w-full">{`"Seit Jahren träume ich von dieser Tour. Aber mit zwei Kindern im Bus? Wenn der Wagen mitten in den Bergen liegen bleibt, wird's teuer und stressig."`}</p>
    </div>
  );
}
        ...
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start justify-end p-[24px] relative size-full">
          ...
          <div className="absolute inset-0 rounded-[24px]" data-name="Image">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[24px]">
              <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[24px] size-full" src={imgRectangle34} />
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[1.3] relative shrink-0 w-full">
      ...
      <p className="font-['Inter:Black',sans-serif] font-black not-italic relative shrink-0 text-[#e6e5e5] text-[18px] w-full">{`"Ich kenne diese Busse in- und auswendig. Ich weiß, was sie können. Und ich weiß, worauf man achten muss."`}</p>
    </div>
  );
}
...
function TestimonialImage1() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] h-full items-start justify-end p-[24px] relative rounded-[24px] shrink-0 w-[512px]" data-name="TestimonialImage">
      ...
      <Frame1 />
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.3] min-w-full relative shrink-0 text-[#e6e5e5] text-[16px] w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>{`Stefan schraubt seit 15 Jahren an T3-Bussen rum. Er hat selbst drei Alpentouren hinter sich. Er sieht sich Marcos Bus an – Wartungszustand, Motor, Reifen – und denkt: "Der schafft das."`}</p>
    </div>
  );
}
...
function TestimonialImage3() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] h-[474px] items-start justify-end p-[24px] relative rounded-[24px] shrink-0 w-[731px]" data-name="TestimonialImage">
      <div className="absolute inset-0 opacity-80 rounded-[24px]" data-name="Abblende" />
...
function SectionHeadline5() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Section Headline">
      <Container5 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.5] not-italic relative shrink-0 text-[#353131] text-[18px] w-full">Erzähl, was dich beschäftigt. Finde jemanden, der sich auskennt. Fahr wieder beruhigt los.</p>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start leading-[1.3] min-h-px min-w-px relative shrink-0 text-[#353131]" data-name="Container">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>{`"Ich habe einen T3 Baujahr 1987. Im Juli will ich mit meinen Kindern über die Alpen nach Italien. Wenn der Bus unterwegs liegen bleibt, wird's teuer. Abschleppen, Werkstatt, eventuell Mietwagen – das können schnell 1.500€ werden."`}</p>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start leading-[1.3] min-h-px min-w-px relative shrink-0 text-[#353131]" data-name="Container">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>{`Stefan schraubt seit Jahren an T3-Bussen. Er sieht deine Anfrage und checkt die Details: Wartung, Zustand, Route. Er denkt: "Der Bus schafft das. Für 180€ Prämie übernehme ich das Risiko."`}</p>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start leading-[1.3] min-h-px min-w-px relative shrink-0 text-[#353131]" data-name="Container">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Du nimmst Stefans Angebot an. Ab sofort kannst du beruhigt in die Berge fahren. Bleibt der Bus liegen, bekommst du 1.500€. Läuft alles glatt, hattest du einfach eine entspannte Tour.
      </p>
    </div>
  );
}
...
function HeroImage1() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative rounded-[24px] self-stretch shrink-0" data-name="Hero Image">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[24px] size-full" src={imgRectangle34} />
    </div>
  );
}
...
export default function LpRisikogeberBus() {
  return (
    <div className="bg-[#fdfcfc] content-stretch flex flex-col items-start relative size-full" data-name="LP / Risikogeber (Bus)">
      <HeroSectionTeaser />
      <SectionWasIstXrisk />
      <Group />
      <SectionWasIstXrisk2 />
