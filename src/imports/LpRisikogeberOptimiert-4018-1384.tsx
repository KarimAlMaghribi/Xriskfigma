import svgPaths from "./svg-zq0suoiof3";
import imgImage from "figma:asset/fea06be5cea92d665177a3b32ba42a925e4a88c3.png";
import imgImage1 from "figma:asset/2fb22e12698929d8163c2e846418914dcd3c2d2e.png";
import imgImage2 from "figma:asset/b4ecfaf9c6e73e8dd6c209458e50397edd6b1743.png";

function Frame32() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center left-[858px] top-[517px] z-[4]">
      <div className="bg-[#d9d9d9] rounded-[16px] shrink-0 size-[92px]" />
      <div className="bg-[#d9d9d9] rounded-[16px] shrink-0 size-[92px]" />
      <div className="bg-[#d9d9d9] rounded-[16px] shrink-0 size-[92px]" />
      <div className="bg-[#d9d9d9] rounded-[16px] shrink-0 size-[92px]" />
    </div>
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start justify-center relative shrink-0 w-[427px] z-[3]">
      <Frame30 />
    </div>
  );
}
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative rounded-[24px] shrink-0 w-full" data-name="Hero Image">
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] isolate items-start justify-center pb-[40px] pl-[40px] pr-[217px] pt-[24px] relative size-full">
          <Frame32 />
          <Frame7 />
          <div className="absolute inset-0 rounded-bl-[24px] rounded-br-[24px] z-[1]" data-name="Image">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-bl-[24px] rounded-br-[24px]">
              ...
              <div className="absolute inset-0 rounded-bl-[24px] rounded-br-[24px]" />
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="h-[800px] relative shrink-0 w-full" data-name="Hero Section - Teaser">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-[800px] items-start justify-center pb-[40px] pt-0 px-[40px] relative w-full">
          <HeroImage />
        </div>
      </div>
    </div>
...
function LeftRow() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[40px] grow h-full items-start justify-center min-h-px min-w-px relative rounded-bl-[24px] rounded-br-[24px] shrink-0" data-name="Left Row">
      <TestimonialImage />
    </div>
  );
}
...
function TestimonialImage1() {
  return (
    <div className="basis-0 grow h-full min-h-px min-w-px relative rounded-[24px] shrink-0" data-name="TestimonialImage">
      <div className="flex flex-col justify-end size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start justify-end p-[24px] relative size-full">
          <div className="absolute inset-0 opacity-80 rounded-[24px]" data-name="Abblende" />
          <div className="absolute inset-0 rounded-[24px]" data-name="Image">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[24px]">
              <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[24px] size-full" src={imgImage2} />
              <div className="absolute bg-gradient-to-b from-[23.077%] from-[rgba(0,0,0,0)] inset-0 rounded-[24px] to-[rgba(0,0,0,0.8)]" />
            </div>
          </div>
          <Frame1 />
...
function RightRow() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow h-full items-center min-h-px min-w-px relative shrink-0" data-name="Right Row">
      <TestimonialImage1 />
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="basis-0 content-stretch flex gap-[40px] grow items-center min-h-px min-w-px relative shrink-0 w-full">
      <LeftRow />
      <RightRow />
    </div>
  );
...
function SectionWasIstXrisk() {
  return (
    <div className="h-[949px] relative shrink-0 w-full" data-name="Section Was ist xrisk">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[40px] h-[949px] items-start p-[40px] relative w-full">
          <SectionHeadline />
          <Frame33 />
        </div>
      </div>
...
function LeftRow1() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start justify-center relative rounded-bl-[24px] rounded-br-[24px] shrink-0 w-full" data-name="Left Row">
      <SectionHeadline1 />
    </div>
  );
}
...
function SectionWasIstXrisk1() {
  return (
    <div className="bg-[#ff671f] relative shrink-0 w-full" data-name="Section Was ist xrisk">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[80px] items-start p-[40px] relative w-full">
          <LeftRow1 />
          <Frame31 />
        </div>
      </div>
...
function HeroImage1() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative rounded-[24px] self-stretch shrink-0" data-name="Hero Image">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[24px] size-full" src={imgImage1} />
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[16px] items-start px-0 py-[8px] relative shrink-0 w-full">
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute bottom-0 left-0 right-0 top-[-2px]" style={{ "--stroke-0": "rgba(206, 202, 202, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 340 2">
            <line id="Line 1" stroke="var(--stroke-0, #CECACA)" strokeWidth="2" x2="340" y1="1" y2="1" />
          </svg>
        </div>
      </div>
      <Frame12 />
...
function Frame11() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col gap-[80px] items-start px-[40px] py-[80px] relative w-full">
          <Frame9 />
        </div>
      </div>
    </div>
...
export default function LpRisikogeberOptimiert() {
  return (
    <div className="bg-[#fdfcfc] content-stretch flex flex-col items-start relative size-full" data-name="LP / Risikogeber (optimiert)">
      <HeroSectionTeaser />
      <SectionWasIstXrisk />
      <SectionWasIstXrisk1 />
